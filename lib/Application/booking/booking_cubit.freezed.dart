...
mixin _$BookingState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, bookAppointment);

  @override
  String toString() {
    return 'BookingState(isLoading: $isLoading, bookAppointment: $bookAppointment)';
  }
}
...
abstract mixin class $BookingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool isLoading, Option<Either<MainFailure, Unit>> bookAppointment});
}
...
class _Initial implements BookingState {
  const _Initial({required this.isLoading, required this.bookAppointment});
